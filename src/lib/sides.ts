...
export const SIDES: SideDefinition[] = [
  ...
  {
    id: "polenta",
    title: "Soft Parmesan Polenta",
    description: "Rain it in whisking, or it lumps.",
    kind: "starch",
    servings: 4,
    prepMinutes: 2,
    cookMinutes: 30,
    equipment: ["Saucepan"],
    ingredients: [
      { name: "polenta", quantity: 1, unit: "cup" },
      { name: "stock", quantity: 4, unit: "cup" },
      { name: "butter", quantity: 3, unit: "tbsp" },
      { name: "parmesan", quantity: 0.5, unit: "cup" },
    ],
    instructions: [
      "Bring the stock to a simmer with a good pinch of salt.",
      "Rain the polenta in while whisking, so it does not lump.",
      "Cook 30 minutes on low, stirring every few minutes, until it falls off the spoon in a soft ribbon.",
      "Beat in the butter and the Parmesan off the heat.",
    ],
    tags: ["Side"],
  },
  {
